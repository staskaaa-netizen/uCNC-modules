...
static const char *g_leancam_templates[] = {
    "OD|D1{(SETUP.OD)}|Z1{(0)}|Z2{(THIS.Z1)}|D2{(THIS.D1)}|CLR{(SETUP.CLR)}",
"ID|D1{(SETUP.ID)}|Z1{(0)}|Z2{(THIS.Z1)}|D2{(THIS.D1)}|CLR{(SETUP.CLR)}",
"FACE|D{(SETUP.OD)}|Z1{(0)}|Z{}|DOC{(1.0)}|CLR{(SETUP.CLR)}",
"DRILL|Z1{(0)}|DEPTH{}|PECK{(0)}|FEED{(120)}|S{(800)}",
"TAP|Z1{(0)}|DEPTH{}|PITCH{}|RPM{(300)}",
"CUT|D{}|Z{}|WIDTH{}|DOC{(1.0)}|CLR{(SETUP.CLR)}",
"CHAMFER|D{}|Z{}|SIZE{(1.0)}|CLR{(SETUP.CLR)}",
"THREAD_OD|D{}|Z2{}|PITCH{}|THR_DEPTH{}|Z1{(0)}|CLR{(SETUP.CLR)}",
"THREAD_ID|D{}|Z2{}|PITCH{}|THR_DEPTH{}|Z1{(0)}|CLR{(SETUP.CLR)}",
"RADIUS_OD|D{}|Z1{(0)}|Z2{}|R{}|CLR{(SETUP.CLR)}",
"RADIUS_ID|D{}|Z1{(0)}|Z2{}|R{}|CLR{(SETUP.CLR)}",
"GROOVE|D1{(SETUP.OD)}|D2{}|Z1{}|Z2{(THIS.Z1)}|WIDTH{}|CLR{(SETUP.CLR)}",
"PART|D{(0)}|Z{}|WIDTH{}|CLR{(SETUP.CLR)}"
};
